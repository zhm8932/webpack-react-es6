...
module.exports = merge(webpackConfig,{
	// devtool: "cheap-module-eval-source-map", // webpack 的默认选项
	module:{
		rules:[
			{
				test:/\.scss$/,
	...
	devServer:{
		contentBase:path.join(commonPath.rootPath, 'dist'),        //默认webpack-dev-server会为根文件夹提供本地服务器，如果想为另外一个目录下的文件提供本地服务器，应该在这里设置其所在目录，告诉服务器从哪里提供内容
